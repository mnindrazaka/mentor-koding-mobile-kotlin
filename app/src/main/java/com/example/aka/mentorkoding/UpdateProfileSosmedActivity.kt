...
import com.example.aka.mentorkoding.databinding.ActivityUpdateProfileSosmedBinding

class UpdateProfileSosmedActivity : AppCompatActivity() {

    private lateinit var apolloClient: ApolloClient
    lateinit var binding: ActivityUpdateProfileSosmedBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = DataBindingUtil.setContentView(this, R.layout.activity_update_profile_sosmed)
